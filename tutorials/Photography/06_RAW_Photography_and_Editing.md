---
layout: default
title: RAW Photography and Image Editing
---
...
# 🖼️ RAW Photography and Image Editing
...
<details class="tutorial-section">
  <summary>
    <span class="section-title">1. Select and prepare the RAW photograph</span>
    <span class="section-description">
      Choose one RAW file and create a separate folder for the editing activity.
    </span>
  </summary>
...
5. Copy the selected RAW file into the new folder.
