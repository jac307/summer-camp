...
<fieldset class="equipment-checklist">
  ...
  <label class="checklist-item">
    ...
    <span>
      ...
      You will control aperture and ISO while the camera selects the shutter speed.
    </span>
  </label>
...
| Frame | White-balance preset | Colour change observed |
|---|---|---|
| 1 | AWB / Auto |  |
| 2 | Daylight |  |
| 3 | Shade |  |
...
<fieldset class="equipment-checklist">
  <legend>Technical Cards final checklist</legend>

  <label class="checklist-item">
    <input type="checkbox">
    <span>
      <strong>All three files are complete.</strong>
      Aperture GIF, ISO Comparison Card, and White Balance GIF.
    </span>
  </label>
  ...
  <label class="checklist-item">
    <input type="checkbox">
    <span>
      <strong>The framing remains consistent.</strong>
      The camera and subject do not jump between comparison images.
    </span>
  </label>
  ...
  <label class="checklist-item">
    <input type="checkbox">
    <span>
      <strong>The focus point remains consistent.</strong>
      Only the intended camera setting changes.
    </span>
  </label>
  ...
  <label class="checklist-item">
    <input type="checkbox">
    <span>
      <strong>The labels are accurate and readable.</strong>
      Every f-stop, ISO value, shutter speed, and white-balance preset is identified correctly.
    </span>
  </label>
  ...
  <label class="checklist-item">
    <input type="checkbox">
    <span>
      <strong>No filters or visual effects were added.</strong>
      The technical differences remain visible and unaltered.
    </span>
  </label>
  ...
  <label class="checklist-item">
    ...
    <span>
      ...
      Each filename includes the participant’s name and the technical setting.
    </span>
  </label>
  ...
  <label class="checklist-item">
    <input type="checkbox">
    <span>
      <strong>The camera was returned to the Day 1 defaults.</strong>
      Set White Balance to Daylight and ISO to 100.
    </span>
  </label>
</fieldset>
