---
layout: default
title: Focal Length, Camera Distance, Perspective, and Depth of Field
---
...
![Diagram comparing the field of view produced by different focal lengths](imgs/LensesDiagram.svg){: .tutorial-image }
...
<div class="media-grid media-grid--three">
  ...
  <figure class="media-card">
    <img
      ...
      class="tutorial-image"
      alt="First focal-length comparison photographed from a fixed camera position."
      loading="lazy"
    >
    <figcaption>
  ...
  <figure class="media-card">
    <img
      src="imgs/LensComparison-2.gif"
      class="tutorial-image"
      alt="Second focal-length comparison photographed from the same fixed camera position."
      loading="lazy"
    >
    <figcaption>
  ...
  <figure class="media-card">
    <img
      src="imgs/LensComparison-3.gif"
      class="tutorial-image"
      alt="Third focal-length comparison photographed from the same fixed camera position."
      loading="lazy"
    >
    <figcaption>
...
<div class="media-grid media-grid--three">
  ...
  <figure class="media-card">
    <img
      src="imgs/LensComparison-4.gif"
      class="tutorial-image"
      alt="Wide focal length used from a close camera position while maintaining the planned subject framing."
      loading="lazy"
    >
    <figcaption>
  ...
  <figure class="media-card">
    <img
      src="imgs/LensComparison-5.gif"
      class="tutorial-image"
      alt="Middle focal length used from an intermediate camera position while maintaining similar subject framing."
      loading="lazy"
    >
    <figcaption>
  ...
  <figure class="media-card">
    <img
      ...
      class="tutorial-image"
      alt="Long focal length used from a distant camera position while maintaining similar subject framing."
      loading="lazy"
    >
    <figcaption>
