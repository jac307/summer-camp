...
<details class="tutorial-section">
  <summary>
    <span class="section-title">6. Complete the settings comparison</span>
    <span class="section-description">
      Organize the test photographs and identify when each additional setting is useful.
    </span>
  </summary>
...
Keep the following comparisons:
...
```text
Name-Lastname-Additional-Settings/
├── Exposure-Compensation/
├── AEB/
└── Custom-White-Balance/
```

Keep both RAW and JPEG files.

## Settings reflection

Complete the statements:

**Metering is useful because:**

>  
_____________________________________________________________

**The histogram helped me identify:**

>  
_____________________________________________________________

**Exposure compensation is different from AEB because:**

>  
_____________________________________________________________

**Custom White Balance is most useful when:**
...
<details class="tutorial-section">
  <summary>
    <span class="section-title">7. Return the camera to the standard settings</span>
    <span class="section-description">
